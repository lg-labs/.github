...
-->
# 🛠️ By developers to developers and utilities.
...
From **Lg Labs** or **Code Labs**! Get the [blank-service][4] template to develop μ-services faster.
...
The License (MIT). Please see [License][LIC] for more information.
...
[4]: https://github.com/lg-labs/blank-service
